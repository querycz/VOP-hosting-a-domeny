...
(dále také jako „Query“)  

## Článek I.
### Základní ustanovení

Odběratel je fyzická či právnická osoba, která si objednala služby u Query, a která nebyla zbavena odpovědnosti k právním úkonům. Objednáním služby a řádným uhrazením fakturované částky Odběratelem dojde k uzavření Smlouvy. Objednáním a uhrazením služby Odběratel projevuje souhlas s těmito Všeobecnými obchodními podmínkami.

Odběratel bere na vědomí, že správa hostingu a správa doménových jmen je výhradně v režii Query. Ve výjimečných případech je Odběrateli na základě zvážení rizik umožněn přístup ke správě hostingu a/nebo jednotlivým službám serveru.

Servery Query jsou umístěny v datovém centru ServerPark na adrese Sodomkova 1579/5, 102 00 Praha 15, který je provozovaný společností VSHosting s.r.o. se sídlem Sodomkova 1579/5, 102 00 Praha 15.

Technický provoz serveru zajišťuje pro Query společnost Fortion Networks, s.r.o. se sídlem Božkovská 307/9, 32600 Plzeň.

Registrátorem doménových jmen pro Query je společnost Gransy s.r.o. se sídlem Bořivojova 878/35, 130 00 Praha.
...
- zjistí-li v průběhu užívání služby bezpečnostní či technickou závadu, neprodleně tuto skutečnost oznámí Query.
...
Zároveň se Odběratel zavazuje, že služby mailového serveru nebude využívat k rozesílání více než 100 e-mailových zpráv za hodinu bez předchozího souhlasu Query.

## Článek IV.
### Přenos dat a kapacita hostingu

Odběratel bere na vědomí, že služby provozované na serverech Query jsou svým zaměřením určeny především pro přenos dat do sítě NIX. Bude-li tranzit u služby Odběratele převyšovat přenos dat do sítě NIX nebo bude-li tranzit u služby Odběratele značně překračovat průměrný tranzit ostatních služeb Query, bude Odběratel o této skutečnosti informován a bude mezi stranami dohodnut další postup.
...
Query se zavazuje, že jako kontakt majitele doménového jména uvede kontaktní údaje Odběratele. Query uvede své kontaktní údaje jako údaje technického kontaktu doménového jména.
...
V případě soudního či jiného obdobného sporu o doménové jméno může Query na základě soudního příkazu či rozhodnutí obdobné povahy znemožnit Odběrateli užívání doménového jména či provést nařízené změny. V případě nařízené změny držitele na jinou osobu nemá Odběratel nárok na vrácení jakýchkoliv poplatků za nevyužití období platnosti domény. Stejně tak nemá Odběratel nárok na kompenzaci jakýchkoliv případných škod způsobených omezením užívání doménového jména či nařízených změn u doménového jména.

Query bezplatně nabízí umístění DNS záznamů domén na svých DNS serverech. Query neručí za případné problémy způsobené poruchou či nedostupností DNS technologie.

Query je oprávněno smazat doménu z DNS systému v případě, že doména DNS servery Query nevyužívá po dobu 60 dní.

## Článek VI.
### Ochrana informací a osobních údajů

Z pohledu Obecného nařízení o ochraně osobních údajů Evropského parlamentu a rady (EU) 2016/679 ze dne 27. 4. 2016 (dále jen „GDPR“) je v rámci používání hostingových služeb Query v roli zpracovatele osobních údajů a Odběratel v roli správce osobních údajů. V rámci obchodního vztahu a správy doménových jmen je Query v roli správce osobních údajů.

Query i Odběratel se zavazují k mlčenlivosti o skutečnostech, které se vzájemně dozvěděli v souvislosti se zřízením a provozem služeb.

Ochrana informací se nevztahuje na případ, kdy má Query informační povinnost stanovenou zákonem, resp. kdy si informace vyžádají státní orgány oprávněné k tomu zákonem, nebo jde o informace, které jsou veřejně dostupné.

Query je oprávněno sdělovat potřebné údaje třetím osobám pro potřeby registrace a správy doménových jmen. V takovém případě Odběratel souhlasí s tím, že jím poskytnuté osobní údaje mohou být zpracovávány touto třetí stranou.

Query se zavazuje zabezpečit ochranu osobních údajů před neoprávněným nebo nahodilým přístupem, zabránit jejich změně, ztrátě či zničení, neoprávněnému přenosu či jejich jinému neoprávněnému zpracování, jakož i jinému zneužití.
...
Query nenese odpovědnost za jakékoliv škody, které Odběrateli případně vzniknou v důsledku uplatnění práva Query přerušení poskytování služby.

O postupu po ukončení Smlouvy, zejména o převedení webových služeb bude Odběratel informován bez zbytečného odkladu.

## Článek IX.
### Reklamace poskytnutých služeb

Query odpovídá za to, že jsou služby Query poskytovány ve shodě se Smlouvou, tj. že odpovídají zaslané nabídce a jsou v souladu s platnými právními předpisy, a dále že jsou poskytovány po sjednanou dobu.
...
Reklamaci Query vyřídí v příslušné zákonem stanovené lhůtě.
...
Odběratel je povinen chránit poskytnutá přístupová jména a přístupová hesla ke zřízeným službám a programovým prostředkům serveru před zneužitím 3. stranou. Na jednání 3. osob, kterým umožní Odběratel (úmyslně i neúmyslně) využívat služby Query (např. administrátoři webů, zaměstnanci, partneři, dodavatelé atd.) se, z hlediska výkonu práv a povinností Odběratele dle této Smlouvy, pohlíží tak, jako by šlo o jednání Odběratele samotného.

Vznikne-li Query v důsledku porušení tohoto článku, článku II nebo III ze strany Odběratele, škoda, má Query právo vymáhat po Odběrateli náhradu této škody.

Náhradu škody má Query právo vymáhat také tehdy, bude-li na Query z důvodu porušení tohoto článku, článku II nebo III ze strany Odběratele vymáhána náhrada škody nebo jiné újmy, finanční zadostiučinění za poškození dobré pověsti, případně jiné obdobné plnění.
